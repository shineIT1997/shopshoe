...
i;e(g).on("init.dt.dtr",function(b,a){if("dt"===b.namespace){const d=a.oInit.rowReorder,c=h.defaults.rowReorder;if(d||c)c=e.extend({},d,c),!1!==d&&new i(a,c)}});return i});
